...
const Contact = () => {
  ...
  return (
    <section className="py-20 px-20 bg-gray-200/60 flex gap-10 justify-between">
      ...
      <div className="bg-white-1 p-8 basis-[65%]">
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)}>
            <div className="my-5 grid grid-cols-2 justify-between gap-10">
            ...
            >
              {loading ? (
                <div className="flex gap-1 items-center w-fit mx-auto">
                  <Loader className="animate-spin w-fit mx-auto" size={24} />
